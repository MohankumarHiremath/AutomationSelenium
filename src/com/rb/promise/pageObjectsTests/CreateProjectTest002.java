...
public class CreateProjectTest002 extends BaseTest{
LoginPageObject loginPage=PageFactory.initElements(driver, LoginPageObject.class);
	...
	@Test
	public void CreateProject002Test(){		
		...
		projectPage.createProject(driver, createProject.NewProject, CreateUpdateDeleteProjectTestData[1]);
	    ...
	    projectPage.createModifyProject(driver, CreateUpdateDeleteProjectTestData[1]);
	    homePage.logOut(driver);
	    ...
	    homePage.clickProjectsLink(driver);
		projectPage.createApproveProject(driver, CreateUpdateDeleteProjectTestData[1]);
	    homePage.logOut(driver);
    	...
    	homePage.clickProjectsLink(driver);
	    projectPage.createGrmApproveProject(driver, CreateUpdateDeleteProjectTestData[1]);
		homePage.logOut(driver);
    	...
    	homePage.clickProjectsLink(driver);
		projectPage.createDHApproveProject(driver, CreateUpdateDeleteProjectTestData[1]);
		homePage.logOut(driver);
	}
